...
class VisualGenomeDataset(Dataset):
    ...
    def _create_ellipse_mask(self, image_shape, bbox):
        ...
        if ellipse_pixel_count > 0:
            ...
            ellipse_value = np.clip(ellipse_value, 0, 255)
    ...
    def __getitem__(self, idx):
        ...
        return {
            "orig_image": orig_image_pil,
            "bbox_mask": bbox_mask_pil,
            "ellipse_mask": ellipse_mask_pil,
            "text": text,
            "bbox": bbox,
        }
...
class RefCOCOPlusDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return {
            "orig_image": orig_image_pil,
            "binary_mask": binary_mask_pil,
            "gray_mask": gray_mask_pil,
            "text": text,
            "bbox": bbox,
        }
